                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <x-table>
                        <div class="mt-4 inline-block">
                            <label for="category-sort" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Sort by Category:
                            </label>
                            <select id="category-sort" name="category-sort" 
                                ...
                                <option value="{{ route('book') }}">All Categories</option>
                                @foreach ($categories as $category)
                                    <option value="{{ route('book', ['category' => $category->id]) }}"
